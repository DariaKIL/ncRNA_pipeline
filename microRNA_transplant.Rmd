...
*Cadherin binding, actin binding, tubulin binding*. 
Кадгерины и актин-ассоциированные белки участвуют в поддержании целостности эндотелия сосудов. Гуморальное отторжение вызывает повреждение эндотелия, воспаление и дестабилизацию межклеточных контактов, что может объяснить даунрегуляцию этих путей.  
*GTPase binding, small GTPase binding, GTPase regulator activity, nucleoside-triphosphatase regulator activity*. 
GTPазы, такие как Rho, Rac, Cdc42, участвуют в регуляции эндотелиальной функции, миграции клеток и ремоделировании сосудов. Их подавление может указывать на:  
	•	Ослабление клеточного ответа на воспаление. 
	•	Нарушение ангиогенеза. 
	•	Подавление реорганизации цитоскелета. 
*DNA-binding transcription factor binding, RNA polymerase II-specific DNA-binding transcription factor binding, transcription coregulator binding, transcription coactivator activity, transcription corepressor activity*. 
	•	Это ключевые регуляторы иммунного ответа, репарации тканей и ангиогенеза.  
	•	Их подавление может указывать на глобальное снижение транскрипционной активности в повреждённых тканях.  
Cвязь с гуморальным отторжением:  
	•	В острую фазу происходит активация NF-κB, STAT1, IRF1 → но в хроническую фазу транскрипционная активность падает из-за повреждения эндотелия и истощения клеточного ответа.  
*Ubiquitin protein ligase binding, ubiquitin-like protein ligase binding, ubiquitin-like protein transferase activity, ubiquitin-like protein binding, ubiquitin-protein transferase activity*
Убиквитин-протеасомная система (UPS) регулирует деградацию повреждённых белков, иммунный ответ, контроль за уровнем сигнальных молекул (например, NF-κB). 
Даунрегуляция может означать:  
	•	Снижение адаптивного ответа клетки на стресс. 
	•	Аномальное накопление белков → что может приводить к дисфункции эндотелия. 
UPS важна для регуляции воспалительного ответа → если она подавлена, то это может способствовать хроническому воспалению и фиброзу.  
*Protein serine/threonine kinase activity, protein serine kinase activity*. 
	•	Включает ключевые сигнальные молекулы MAPK, AKT, mTOR. 
	•	Подавление их активности может отражать дисфункцию клеточного ответа и метаболические изменения. 
	•	Подавление mTOR-сигналинга может ослаблять пролиферацию эндотелиальных клеток, способствуя прогрессии сосудистого ремоделирования.  
